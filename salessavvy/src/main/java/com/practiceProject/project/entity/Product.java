...
public class Product {
	...
	// Stores long text content such as product description
	// TEXT datatype allows storing large amounts of text
	...
	// CURRENT_TIMESTAMP automatically inserts current date and time
	@Column(nullable = false, columnDefinition = "TIMESTAMP DEFAULT CURRENT_TIMESTAMP")
	private LocalDateTime createdAt;


	// Stores the timestamp of the latest update
	// Automatically updates time whenever the record is modified
